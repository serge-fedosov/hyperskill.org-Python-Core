class ComplexNumber:
    ...
    def __truediv__(self, other):
        other_real_part = other.real_part / (other.real_part * other.real_part + other.im_part * other.im_part)
        other_im_part = - other.im_part / (other.real_part * other.real_part + other.im_part * other.im_part)

        real = self.real_part * other_real_part - self.im_part * other_im_part
        imaginary = self.real_part * other_im_part + other_real_part * self.im_part
        return ComplexNumber(real, imaginary)
